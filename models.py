...
class GMNlayer(MessagePassing):
    def __init__(self, in_channels, out_channels,device):
        ...
        self.fmessage = nn.Linear(3*in_channels, out_channels)#消息函数
    ...
    def forward(self, x1,x2, edge_index1,edge_index2,edge_weight1,edge_weight2,mode='train'):
        ...
        # print(attnsum_1,attnsum_2)
        # print(len(attnsum_1),len(attnsum_2))
        u1=x1-attnsum_1
        u2=x2-attnsum_2
        ...
        h2=self.fnode(m2,x2)
        return h1,h2,scores,attn_1,attn_2
...
class GMNnet(torch.nn.Module):
    ...
    def forward(self, data,mode='Train'):
        ...
        for i in range(self.num_layers):
            x1, x2,score,attn_1,attn_2 = self.gmnlayer.forward(x1, x2, edge_index1, edge_index2, edge_weight1, edge_weight2, mode='train')
        ...
        return hg1,hg2,score,attn_1,attn_2,x1,x2
